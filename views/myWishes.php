                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <form method="POST" class="mt-auto">
                                    <div class="text-center border-top">
                                        <button class='btn shadow-none' type='submit' name='submit-remove-wish-<?= $figure['id'] ?>'><i class='bi bi-x-circle-fill redDBZColor h3'></i></button>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <form method="POST">
                                <?php foreach ($listLimitMyWishes as $figure) { ?>
                                    <tr class="align-middle">
                                        ...
                                        <td width="5%"><button class='btn shadow-none' type='submit' name='submit-remove-wish-<?= $figure['id'] ?>'><i class='bi bi-x-circle-fill redDBZColor h3'></i></button></td>
                                    </tr>
                                <?php } ?>
                            </form>
                        </tbody>
...
<?php if (!empty($_POST)) { ?>
    <script>
        swal({
            ...
            text: "La figurine <?= $figureDetailsArray['full_name'] ?> a bien été retirée de votre liste de Souhaits.",
            icon: 'success',
            dangerMode: true,
            button: {
                text: "Continuer"
