        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-2 m-auto">
                    <a class="text-decoration-none account d-flex justify-content-end" href="connexion.html"
                        id="myAccount">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top p-0" id="myNav">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><img class="logoZ"
                        src="assets/img/logoConnect.gif" alt="Logo gif Z">Menu</h5>
