<?php
require_once "../controllers/addFigureSerieController.php";
include("header.php");
?>

<div class="container bg-white content pt-3 pb-3 my-5" id="contentId">
    <p class="h3 text-center mb-0">Ajouter une série à la Figurine</p>
                        ...
                        <div class="col-6 m-auto">
                            ...
                            <div>
                                <select class="form-select" name="serie" id="serie">
                                    <option value="">-- Choix d'une Série --</option>
                                    <?php foreach ($allSeriesArray as $serie) { ?>
                            ...
                            <div class="text-center">
                                <input type="submit" class="btn greenDBZBack rounded-3 text-white pt-2 pb-2 ps-4 pe-4" name="submitSerie" value="Ajouter Serie">
