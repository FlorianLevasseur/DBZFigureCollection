...
<div class="container bg-white content pt-3 pb-3 my-5" id="contentId">
    <div class="row m-0 p-0 justify-content-center mb-4">
        <div class="col-lg-6">
            <p class="h3 mb-4 text-center">Créez votre compte</p>
            <form method="POST" class="border border-reset pt-4">
                <div class="form-group row m-0 p-0 pb-3">
                    <label for="pseudo" class="col-lg-4 form-control-label pt-2 alignLabel">Pseudo</label>
                    <div class="col-lg-7">
                ...
                <div class="form-group row m-0 p-0 pb-3">
                    <label for="password" class="col-lg-4 form-control-label pt-2 alignLabel">Mot de Passe</label>
                    <div class="col-lg-7">
                ...
                <div class="form-group row m-0 p-0 pb-3">
                    <label for="confirmPassword" class="col-lg-4 form-control-label pt-2 alignLabel">Confirmez Mot de Passe</label>
                    <div class="col-lg-7">
                ...
                <hr>
                <p class="text-center">Vous avez déjà un compte ? <a href="connexion">Connectez-vous !</a></p>
            </form>
        </div>
    </div>
</div>
